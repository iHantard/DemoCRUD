...
namespace DemoCRUD.Controllers
{
    public class LivrosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Titulo,Autor,Valor,AnoEdicao,GeneroId")] Livro livro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Titulo,Autor,Valor,AnoEdicao,GeneroId")] Livro livro)
        {
            if (ModelState.IsValid)
            {
